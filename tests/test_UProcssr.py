...
def test_proc_pnumber():
    ...
    p.reset()
    assert p.lop.value == 0 and p.right.value == 0 and p.op is None
...
def test_proc_frac():
    ...
    p.reset()
    assert p.lop.to_string() == "0/1" and p.right.to_string() == "0/1" and p.op is None
...
def test_proc_comp():
    ...
    p.reset()
    assert p.lop.to_string() == "0.0+0.0i" and p.right.to_string() == "0.0+0.0i" and p.op is None
